...
func (c *cefClientStub) GetContextMenuHandler() cef.ContextMenuHandler {
	return getCefContextMenuHandler(c.w)
}
...
func (c *cefClientStub) OnProcessMessageReceived(_ cef.Browser, frame cef.Frame, source cef.ProcessID, message cef.ProcessMessage) int32 {
	return cefHandleRendererProcessMessage(frame, source, message)
}
